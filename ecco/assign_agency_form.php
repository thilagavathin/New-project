    ...
    <div class="col-md-8 col-md-offset-2">
        <form class="form-horizontal ga-form" role="form" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <div class="m-t-20">
                        <select class="form-control" name="assign_user" id="assign_user" data-init-plugin="select2">
            ...
            <div class="text-right m-t-40">
                ...
                <button type="button" onclick="addassign_normal();" class="btn btn-primary">Assign</button>
            </div>
