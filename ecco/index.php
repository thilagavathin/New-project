                    ...
                    <div class="row mar0">
                            ...
                            <form class="form-horizontal login-form" id="form-login">
                              ...
                              <div class="form-group">
                                  <div class="col-sm-8 col-xs-8">
                                      <label class="mar0 text_blue">
                                          <input type="checkbox" value="option1" id="checkbox">
                                          <span class="custom-icon checkbox-icon"></span>Keep me signed in
                                      </label>
                                      <p><a class="small forget-pwd" href="forget_password.php">Forgot my Password</a></p>
                                  </div>
                        ...
                        <!-- form ends -->
                            <div class="join-now">
                                ...
                                <p class="text-capitalize mar_t10">training and technical assistance tracker</p>
                                <div class="row text-center">
                                    <figure class="col-sm-12 col-xs-12">
            ...
            if(username != "" && password != ""){
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if($success=='success') window.location.href='systemdashboard.php';
                        else
                        {
