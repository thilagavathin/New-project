...
$regarding_notes=mysql_real_escape_string($_POST['regarding_notes']);
  	 	...
  	 	<table style="width:100%; ">
  	 		<tr>
  	 			<td style="padding-top:0; padding-left:20px;">
  	 				...
  	 				<p style="font-family: \'Roboto\'; font-weight:300; color:#284fa3; font-size:18px;">'.$regarding_notes.'</p>
...
$insert_query="INSERT INTO tta_regarding_notes (username,user_id,agency_id,contract_num,comments,created_date) VALUES ('".$username."',".$user_id.",".$agency_id.",'".$contract."','".$regarding_notes."','".$current_date."')";
