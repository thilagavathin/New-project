...
if(isset($_POST['intervention_id'])){ 
	...
	$pb_iden_activity = array();
	$pb_iden_activity_type = array();
    ...
    $pb_iden_activity= ($intervention_row['pb_iden_activity']!=''?unserialize($intervention_row['pb_iden_activity']):array());
	$pb_iden_activity_type= ($intervention_row['pb_iden_activity_type']!=''?unserialize($intervention_row['pb_iden_activity_type']):array()); 
    ...
    <div id="collapse4" class="panel-collapse collapse <?php echo $PartD; ?>">
      ...
      <form id="partDForm" multipart="" enctype="multipart/form-data">
        ...
        <div class="col-md-6">
            <div class="form">                
                ...
                <div class="form-group">
                  ...
                  <?php    
                    $sql = "select id,strategy_name from strategy_model where strategy_type='5'";
                ...
                <div class="form-group">
                    <label class="ele_bl"><span class="text_blue bold">4. </span> Age groups to be served by this Problem Identification and Referral intervention this year? (Select all that apply)</label>
			    ...
			    <div class="form-group">
				<label class="ele_bl"><span class="text_blue bold">5. </span>Population type(s) to be targeted by problem identification and referral intervention this year.(Select all that apply) </label>
					<select class="form-control resources_select" multiple="" name="target_population[]" id="target_population" onchange="toggle_multiselect(this.value,'target_population','target_population_other_cover')">			
						...
						<option <?php if(in_array('Employees',$target_population)) {echo 'selected="selected"';} ?> value="Employees">Employees</option>
		...
		<div class="col-md-6">
            <div class="form"> 
				<div class="form-group">
				<label class="ele_bl"><span class="text_blue bold">6. </span>Where will the problem identification and referral activities take place this year? (Select all that apply) </label>
					<select class="form-control resources_select" multiple="" name="pb_iden_activity[]" id="pb_iden_activity" onchange="toggle_multiselect(this.value,'pb_iden_activity','pb_iden_activity_other_cover')">			
						<option <?php if(in_array('School',$pb_iden_activity)) {echo 'selected="selected"';} ?> value="School">School</option>
						<option <?php if(in_array('Health care facilities',$pb_iden_activity)) {echo 'selected="selected"';} ?> value="Health care facilities">Health care facilities</option>
						<option <?php if(in_array('Jails or prisons',$pb_iden_activity)) {echo 'selected="selected"';} ?> value="Jails or prisons">Jails or prisons</option>
						<option <?php if(in_array('Courts',$pb_iden_activity)) {echo 'selected="selected"';} ?> value="Courts">Courts</option>
						<option <?php if(in_array('Workplace or workplace program',$pb_iden_activity)) {echo 'selected="selected"';} ?> value="Workplace or workplace program">Workplace or workplace program</option>
						<option <?php if(in_array('Other',$pb_iden_activity)) {echo 'selected="selected"';} ?> value="Other">Other(Describe.)</option>
					</select>
						<div class="form-group" style="<?php if(in_array('Other',$pb_iden_activity)){echo 'display: block;';}else{echo 'display: none;';} ?>" id="pb_iden_activity_other_cover" >
							<label></label>
							<input type="text" placeholder="Describe" class="form-control" name="pb_iden_activity_other" value="<?php echo $intervention_row['pb_iden_activity_other'];  ?>" id="pb_iden_activity_other_text" />
					   </div>
				</div>
				<div class="form-group">
                    <label class="ele_bl"><span class="text_blue bold">7. </span>Will problem identification and referral activities be implemented in a series of cycles, in which a new group of participants is served on a regular schedule, such as a new school year? </label>
				...
				<div class="form-group" >
                    <label class="ele_bl"><span class="text_blue bold">7a. </span>Number of cycles to be implemented this fiscal year? </label>
				...
				<div class="form-group" >
                    <label class="ele_bl"><span class="text_blue bold">8. </span>At how many different locations will problem identification and referral activity occur this year? </label>
					<select class="form-control" name="pb_diff_loc">
						<option value="">Select</option>
						<?php for($j=1;$j<=50;$j++){?>
							<option <?php if($intervention_row['pb_diff_loc']==$j){echo 'selected="selected"';} ?> value="<?php echo $j; ?>"><?php echo $j; ?></option>
						<?php }?>
					</select>
				</div>
				
				<div class="form-group sitting_location_cover">
				  <label><span class="text_blue bold">9. </span>Setting(s)/Location(s)</label>
				  <?php
				...
				<div class="form-group" >
                    <label class="ele_bl"><span class="text_blue bold">10. </span>To what type(s) of services will you be referring individuals this year? (Select all that apply) </label>
						<select class="form-control resources_select" multiple="" name="pb_iden_activity_type[]" id="pb_iden_activity_type" onchange="toggle_multiselect(this.value,'pb_iden_activity_type','pb_iden_activity_type_other_cover')">			
							<option <?php if(in_array('Substance abuse treatment',$pb_iden_activity_type)) {echo 'selected="selected"';} ?> value="Substance abuse treatment">Substance abuse treatment</option>
							<option <?php if(in_array('Mental health treatment',$pb_iden_activity_type)) {echo 'selected="selected"';} ?> value="Mental health treatment">Mental health treatment</option>
							<option <?php if(in_array('Substance abuse prevention activities',$pb_iden_activity_type)) {echo 'selected="selected"';} ?> value="Substance abuse prevention activities">Substance abuse prevention activities</option>
							<option <?php if(in_array('Housing services',$pb_iden_activity_type)) {echo 'selected="selected"';} ?> value="Housing services">Housing services</option>
							<option <?php if(in_array('After-school activities',$pb_iden_activity_type)) {echo 'selected="selected"';} ?> value="After-school activities">After-school activities</option>
							<option <?php if(in_array('Transportation',$pb_iden_activity_type)) {echo 'selected="selected"';} ?> value="Transportation">Transportation</option>
							<option <?php if(in_array('Day care or adult care services',$pb_iden_activity_type)) {echo 'selected="selected"';} ?> value="Day care or adult care services">Day care or adult care services</option>
							<option <?php if(in_array('Health care',$pb_iden_activity_type)) {echo 'selected="selected"';} ?> value="Health care">Health care</option>
							<option <?php if(in_array('Other',$pb_iden_activity_type)) {echo 'selected="selected"';} ?> value="Other">Other(Describe.)</option>
						</select>
						<div class="form-group" style="<?php if(in_array('Other',$pb_iden_activity_type)){echo 'display: block;';}else{echo 'display: none;';} ?>" id="pb_iden_activity_type_other_cover" >
							<label></label>
							<input type="text" placeholder="Describe" class="form-control" name="pb_iden_activity_type_other" value="<?php echo $intervention_row['pb_iden_activity_type_other'];  ?>" id="pb_iden_activity_type_other_text" />
					   </div>
				</div>
			</div>
        </div>
