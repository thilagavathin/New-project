...
<table cellspacing="0">
	...
	<?php $types_of_participants1 = implode(",",$types_of_participants); ?>
	<tr>
		<td class="pad15" style="width: 5%; text-align:left;">4</td>
		<td class="pad15" style="width: 30%; text-align:left;">Age group targeted by this intervention</td>
		<td class="pad15" style="width: 65%; text-align:left;"><?php echo $types_of_participants1; ?></td>
	</tr>
	<?php if(in_array('Other',$types_of_participants)) { ?>
	<tr>
		<td class="pad15" style="width: 5%; text-align:left;"></td>
		<td class="pad15" style="width: 30%; text-align:left;">Other</td>
		<td class="pad15" style="width: 30%; text-align:left;"><?php echo $intervention_row['types_of_participants_other']; ?></td>
	</tr>
	<?php } ?>
	<?php $target_population1 = implode(",",$target_population); ?>
	<tr>
		<td class="pad15" style="width: 5%; text-align:left;">5</td>
		<td class="pad15" style="width: 30%; text-align:left;">Population type(s) targeted for this intervention</td>
