...
if(isset($_POST['intervention_id'])){ 
	...
	$alternative_activity_types=array();
	...
	$alternative_activity_types= ($intervention_row['alternative_activity_types']!=''?unserialize($intervention_row['alternative_activity_types']):array());
}
 ?>
        ...
        <div class="col-md-6">
            <div class="form">                
                ...
                <div class="form-group" style="<?php if($intervention_row['EBP']=='Yes'){echo 'display: block;';}else{echo 'display: none;';} ?>" id="evidence_type_cover">
                  ...
                  <select class="form-control strategy_select" id="strategy_model" name="strategy_model" onchange="toggle_select(this.value,'strategy_model_other_cover')">
                ...
                <div class="form-group">
                  <label><span class="text_blue bold">4. </span>Social-Ecological Target of this intervention</label>
                ...
                <div class="form-group">
                  <label><span class="text_blue bold">5. </span>Age group(s) targeted for this intervention (select all that apply)</label>
                  ...
                  <option <?php if(in_array('Other',$types_of_participants)){echo 'selected="selected"';} ?> value="Other">Others(Describe.)</option>
				...
				<div class="form-group">
				<label><span class="text_blue bold">6. </span>Population type(s) targeted for this intervention (select all that apply)</label>
					<select class="form-control resources_select" multiple="" name="target_population[]" id="target_population" onchange="toggle_multiselect(this.value,'target_population','target_population_other_cover')">                  
                      ...
                      <option <?php if(in_array('Other',$target_population)){echo 'selected="selected"';} ?> value="Other">Others(Describe.)</option>
				...
				<div class="form-group">
                    <label class="ele_bl"><span class="text_blue bold">7. </span>Will alternative activities target identifiable participants (as in student clubs, mentoring) or with events for populations as a whole (as in drug-free events, festivals/fairs, drop-in activities)? (Select all that apply)</label>
					<select class="form-control resources_select" multiple="" id="alternative_participants" name="alternative_participants[]" onchange="alternative_participants1(this.value,'activity_type_cover')">
						  <option value="">select</option>
						  <option <?php if(in_array('Identifiable participants',$alternative_participants)) {echo 'selected="selected"';} ?> value="Identifiable participants">Identifiable participants</option>
						  <option <?php if(in_array('Populations as a whole',$alternative_participants)){echo 'selected="selected"';} ?> value="Populations as a whole">Populations as a whole</option> </select>
				</div>
				
                <div class="form-group">
                    <label class="ele_bl"><span class="text_blue bold">8. </span>Are these recurring activities in which the same group of people are served over multiple sessions?</label>
                    <label class="checkbox_normal mar_r15">
            	...
            	<div class="form-group">
                <label class="ele_bl"><span class="text_blue bold">8a. </span>What is the average number of sessions per group?</label>
				...
				<div class="form-group">
                    <label class="ele_bl"><span class="text_blue bold">8b. </span>What is the average length of each session that will be offered? </label>
                ...
                <div class="form-group">
                    <label class="ele_bl"><span class="text_blue bold">8c. </span>How frequently will sessions be implemented?</label>
					...
					<option <?php if($intervention_row['frequency']=='Other'){echo 'selected="selected"';} ?> value="Other">Others(Describe.)</option>
				...
				<div class="form-group">
				<label class="ele_bl"><span class="text_blue bold">9. </span>Is this intervention implemented in a series of cycles, in which a new group of participants is served on a regular schedule, such as a new school year?</label>
				...
				<div class="form-group">
                    <label class="ele_bl"><span class="text_blue bold">10. </span>What are the formats of the alternative activities you will be implementing?</label>
				...
				<div style="<?php if(in_array('Populations as a whole',$alternative_participants)){echo 'display: block;';}else{echo 'display: none;';} ?>" id="activity_type_cover"   > 
				<div class="form-group">
                    <label class="ele_bl"><span class="text_blue bold">11. </span>What type(s) of the alternative activities events that are not targeted to identifiable participants will you implement this year? (select all that apply)</label>
						<select class="form-control resources_select" multiple="" name="alternative_activity_types[]" id="alternative_activity_types" onchange="toggle_multiselect(this.value,'alternative_activity_types','alternative_activity_types_other_cover')">
							<option value="">Select</option>
							<option <?php if(in_array('Concert',$alternative_activity_types)) {echo 'selected="selected"';} ?> value="Concert">Concert</option>
							<option <?php if(in_array('Festival or fair',$alternative_activity_types)) {echo 'selected="selected"';} ?> value="Festival or fair">Festival or fair</option>
							<option <?php if(in_array('Sporting event',$alternative_activity_types)) {echo 'selected="selected"';} ?> value="Sporting event">Sporting event</option>
							<option <?php if(in_array('Picnic',$alternative_activity_types)) {echo 'selected="selected"';} ?> value="Picnic">Picnic</option>
							<option <?php if(in_array('Drop-in activity',$alternative_activity_types)) {echo 'selected="selected"';} ?> value="Drop-in activity">Drop-in activity</option>
							<option <?php if(in_array('Web-based gathering',$alternative_activity_types)) {echo 'selected="selected"';} ?> value="Web-based gathering">Web-based gathering</option>
							<option <?php if(in_array('Other',$alternative_activity_types)) {echo 'selected="selected"';} ?> value="Other">Other(Describe.)</option>
							<!-- <option <?php if($intervention_row['alternative_activity_types']=='Concert'){echo 'selected="selected"';} ?> value="Concert">Concert</option>
							<option <?php if($intervention_row['alternative_activity_types']=='Festival or fair'){echo 'selected="selected"';} ?> value="Festival or fair">Festival or fair</option>
							<option <?php if($intervention_row['alternative_activity_types']=='Sporting event'){echo 'selected="selected"';} ?> value="Sporting event">Sporting event</option>
							<option <?php if($intervention_row['alternative_activity_types']=='Picnic'){echo 'selected="selected"';} ?> value="Picnic">Picnic</option>
							<option <?php if($intervention_row['alternative_activity_types']=='Drop-in activity'){echo 'selected="selected"';} ?> value="Drop-in activity">Drop-in activity</option>
							<option <?php if($intervention_row['alternative_activity_types']=='Web-based gathering'){echo 'selected="selected"';} ?> value="Web-based gathering">Web-based gathering</option>
							<option <?php if($intervention_row['alternative_activity_types']=='Other'){echo 'selected="selected"';} ?> value="Other">Other(Describe.)</option> -->
							
						</select>
				<div class="form-group" style="<?php if(in_array('Other',$alternative_activity_types)){echo 'display: block;';}else{echo 'display: none;';} ?>" id="alternative_activity_types_other_cover" >
				<label></label>					
					<input type="text" placeholder="Describe" name="alternative_activity_types_other" class="form-control" id="alternative_activity_types_other_text" value="<?php echo $intervention_row['alternative_activity_types_other']; ?>" />
				</div>
				</div>
				</div>
				
				<div class="form-group">
                    <label class="ele_bl"><span class="text_blue bold">12. </span>Number to be served or reached</label>
                ...
                <div class="form-group sitting_location_cover">
                    <label><span class="text_blue bold">13. </span>Setting(s)/Location(s)</label>
                <?php 
                $site_location=unserialize($intervention_row['site_location']);
                $activity_location_count=count($site_location);
                ...
                for($c=1;$c<=$settings_locations_count;$c++){?>
                      ...
                      <div class="form-group">                        
    					<input type="text" class="form-control" placeholder="13a. Activity name" name="site_location[<?php echo $c; ?>][activity_name]" value="<?php echo $site_location[$c]['activity_name'];?>"/>
    				  </div>   
					  <div class="form-group">
    					<select class="form-control" name="site_location[<?php echo $c; ?>][activity_types]" onchange="toogle_select(this.value,'activity_types_other_cover<?php echo $c; ?>')">
    						<option <?php if($site_location[$c]['activity_types']==''){echo 'selected="selected"';} ?> value="">13b. Activity type</option>
    						<option <?php if($site_location[$c]['activity_types']=='Concert'){echo 'selected="selected"';} ?> value="Concert">Concert</option>
    						<option <?php if($site_location[$c]['activity_types']=='Festival or fair'){echo 'selected="selected"';} ?> value="Festival or fair">Festival or fair</option>
    						<option <?php if($site_location[$c]['activity_types']=='Sporting event'){echo 'selected="selected"';} ?> value="Sporting event">Sporting event</option>
    						<option <?php if($site_location[$c]['activity_types']=='Picnic'){echo 'selected="selected"';} ?> value="Picnic">Picnic</option>
    						<option <?php if($site_location[$c]['activity_types']=='Drop-in activity'){echo 'selected="selected"';} ?> value="Drop-in activity">Drop-in activity</option>
    						<option <?php if($site_location[$c]['activity_types']=='Web-based gathering'){echo 'selected="selected"';} ?> value="Web-based gathering">Web-based gathering</option>
    						<option <?php if($site_location[$c]['activity_types']=='Other'){echo 'selected="selected"';} ?> value="Other">Other(Describe.)</option>
    					</select>
    					<div class="form-group" style="<?php if($site_location[$c]['activity_types']=='Other'){echo 'display: block;';}else{echo 'display: none;';} ?>" id="activity_types_other_cover<?php echo $c; ?>" >
    					<label></label>
    						<input type="text" placeholder="Describe" name="site_location[<?php echo $c; ?>][activity_types_other]" class="form-control" value="<?php echo $site_location[$c]['activity_types_other']; ?>" />
    				    </div>
    				  </div>          
                      <div class="row">
                        <span class="col-md-6 col-xs-12 mar_b20"><input type="text" class="form-control" placeholder="13c. Location" name="site_location[<?php echo $c; ?>][location]" value="<?php echo $site_location[$c]['location']; ?>"/></span>
                        <span class="col-md-6 col-xs-12 mar_b20"><input type="text" class="form-control col-md-6 col-xs-12" placeholder="13.d City/Town" name="site_location[<?php echo $c; ?>][city]" value="<?php echo $site_location[$c]['city']; ?>"/></span>
                        <span class="col-md-6 col-xs-12"><input type="text" class="form-control col-md-6 col-xs-12" placeholder="13e. Street Address" name="site_location[<?php echo $c; ?>][street_address]" value="<?php echo $site_location[$c]['street_address']; ?>"/></span>
                        <span class="col-md-6 col-xs-12"><input type="text" class="form-control col-md-6 col-xs-12" placeholder="13f. ZIP" name="site_location[<?php echo $c; ?>][zip]" value="<?php echo $site_location[$c]['zip']; ?>"/></span>
                      </div>
                      </div>
                 <?php }?>
				</div>
				<div class="form-group">
                  ...
                  <div class="custom-fileupload">
    				<div class="pull-right"><button type="button" class="add_button" id="add_locations" onclick="add_activity_locations()"><i class="fa fa-plus-circle"></i> Add Locations</button></div>
    			  </div>
                </div>
            </div>
        </div>
          ...
          <div class="row portfolio_workbundle pad_t20">
               ...
               <div class="col-md-6 col-xs-12">
                    <div class="form">
                      ...
                      <div class="form-group">
                        <label><span class="text_blue bold">2. </span>Work Bundle Name - Alternative Drug-Free Activities</label>
                       ...
                       <select class="form-control" id="work_bundle<?php echo $w; ?>" name="work_bundle[]">
							...
							<?php
									...
									<?php } ?>
							<!-- 		
                            <option <?php if($work_bundle[$w]=='Develop recruitment/promotional materials'){echo 'selected="selected"';} ?> value="Develop recruitment/promotional materials">Develop recruitment/promotional materials</option>
                            <option <?php if($work_bundle[$w]=='Develop or order curriculum/program materials'){echo 'selected="selected"';} ?> value="Develop or order curriculum/program materials">Develop or order curriculum/program materials</option>
							...
							<option <?php if($work_bundle[$w]=='Update key stakeholders'){echo 'selected="selected"';} ?> value="Update key stakeholders">Updates key stakeholders</option>
							<option <?php if($work_bundle[$w]=='Update coalition members'){echo 'selected="selected"';} ?> value="Update coalition members">Update coalition members</option>
                            ...
                            <option <?php if($work_bundle[$w]=='Conduct event 1'){echo 'selected="selected"';} ?> value="Conduct event 1">Conduct event 1</option>
							-->
					   </select>
                        <!--
